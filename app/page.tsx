...
export const metadata: Metadata = {
  title: 'Ulus Meydan | Ankara\'nın Güncel Haber Gazetesi — Ulus Meydanı Haberleri',
  description: "Ulus Meydan — Ulus Meydanı, Ankara ve Türkiye'den dakika dakika güncel haberler. Siyaset, ekonomi, spor, kültür-sanat haberleri ve son dakika gelişmeleri için Ulus Meydan'ı takip edin.",
  keywords: [
  ...
  openGraph: {
    ...
    title: 'Ulus Meydan | Ankara\'nın Güncel Haber Gazetesi',
  ...
  twitter: {
    ...
    title: 'Ulus Meydan | Ankara Haberleri',
          ...
          <div className="flex flex-col lg:flex-row flex-1 min-w-0 gap-6">
            ...
            <div className="hidden xl:flex flex-col gap-5 w-56 shrink-0">
              ...
              <div className="bg-[#1a1a2e] px-4 py-4 text-center rounded-lg">
                ...
                <div className="text-[18px] font-black text-white leading-tight">0 553 321 97 79</div>
              ...
              <div className="relative z-10 flex items-center" style={{ minHeight: 150 }}>
                ...
                <div className="flex flex-col items-center justify-center flex-1 text-center px-3 py-4 gap-2">
                  ...
                  <div className="flex gap-3">
                    ...
                    <a href="https://x.com/ulusmeydan" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white transition-colors">
